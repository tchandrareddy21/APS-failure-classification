        ...
        try:
            ...
            if not model_resolver.is_model_exists():
                model_evaluation_artifact = ModelEvaluationArtifact(
                    ...
                    trained_model_metric_artifact= self.model_trainer_artifact.test_metric_artifcat,
                    best_model_metric_artifact= None
                )
                logging.info(f"Model evaluation artifact: {model_evaluation_artifact}")
                return model_evaluation_artifact
            
            latest_model_path = model_resolver.get_bets_model_path()
            ...
            latest_metrc = get_classification_score(y_true, y_latest_pred)

            improved_accuracy = trained_metric.f1_score - latest_metrc.f1_score
            ...
            model_evaluation_artifact = ModelEvaluationArtifact(
                ...
                best_model_metric_artifact= latest_metrc
            )
